...
export type CloseInput<
  ...
  TAccountVotingsdapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountVotingsdapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountVotingsdapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.votingsdapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountVotingsdapp>;
